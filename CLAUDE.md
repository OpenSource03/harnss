...
- `SplitPaneToolStrip.tsx` — tool strip icon bar for a split pane
- `SplitBottomToolIsland.tsx` — renders a single tool island in the split-view bottom dock; extracted from `renderSplitBottomToolIsland` in AppLayout
